...
对话交互 · 知识库上传/检索 · 业务插件（订单/退款/物流/工单）· 支持插件迭代 · 配套 AI 测试方案与 3–5 天培训交付。
...
不部署也可直接阅读 `docs/` 五篇文档，按「为什么 → 做什么 → 怎么做 → 怎么保证质量 → 怎么交付」的顺序，即可完整讲解整个方案。
...
| 岗位职责 | 本项目对应产出 |
| --- | --- |
| ① 搭建行业专属轻量级智能体 | 本仓库：人设 + 知识库 + 插件，支持插件迭代 |
| ② 规划与执行 AI 测试流程 | `docs/04`：测试策略 / 用例 / 功能测试 / 报告 / 缺陷闭环 |
| ③ 测试环境搭建与工具优化 | `docs/04`：隔离环境 / Mock 数据 / 自动化 / 度量指标 |

3–5 天培训大纲、里程碑、风险与验收标准见 `docs/05`。

## 📚 文档

| 文档 | 内容 |
| --- | --- |
| [01-项目方案与总体架构](docs/01-项目方案与总体架构.md) | 背景 / 目标 / 场景 / 分层架构 / 选型 |
| [02-功能与产品设计](docs/02-功能与产品设计.md) | 对话 / 知识库 / 插件 三大功能需求与优先级 |
| [03-知识库与插件技术设计](docs/03-知识库与插件技术设计.md) | 检索算法 / 插件契约 / 数据模型 / 演进路线 |
| [04-测试方案与工具优化](docs/04-测试方案与工具优化.md) | 测试策略 / 用例 / 执行 / 报告 / 闭环 / 环境与工具 |
| [05-培训交付与验收](docs/05-培训交付与验收.md) | 3–5 天培训 / 里程碑 / 风险 / 验收 |
